...
export class LoggerService {
  ...
  constructor() {
    // Si estamos en modo desarrollo, queremos ver todo 
  ...
  /**
   * Se encarga de dejar bien estructurado el mensaje: prefijo, nivel y hora exacta
   */
  ...
  /**
   * Acá se hace la cosa con el `console` nativo según el nivel del log
   */
